import { $dom } from './dom';
export const insertAfter = function (el, element) {
 ...
 * 创建一个子节点并放置
 */
export const createChild = function (parent, tag, obj, positon) {
 ...
 * @param obj 需要被包装的对象
 */
export const wrapObject = function (parent, obj) {
...
export const getTop = function (el) {
    return el.getBoundingClientRect().top;
};
export const getLeft = function (el) {
    return el.getBoundingClientRect().left;
};
export const getDisplay = function (el) {
    return el.style.display;
};
export const setDisplay = function (el, d) {
    el.style.display = d;
    return el;
};
